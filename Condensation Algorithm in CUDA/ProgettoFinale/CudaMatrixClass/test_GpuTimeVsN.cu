/*//------------------------------------------------------------------------------------------------------------
| TEST del tempo d'esecuzione della routine Gpu in funzione del numero N di elementi per lato
|	
|       
*///------------------------------------------------------------------------------------------------------------
...
int main(void){
	...
	int Nstep =100;
	ofstream myfile;
	myfile.open ("Output/GpuTimeVsN_GTX480.dat",ofstream::app);
	int n=10;
	float Dati[n];
