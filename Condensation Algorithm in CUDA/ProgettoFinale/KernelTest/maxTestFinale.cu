//MEMENTO! compilare cosi' " nvcc -arch sm_11 "
...
#include "cuda_runtime.h"//MEMENTO! compilare cosi' " nvcc -arch sm_11 "
#include "lock.h"
...
//KERNEL!
	...
	Lock lock;
  MaxValue<<<blocksPerGrid,threadsPerBlock>>>(lock,A_dev,N,
