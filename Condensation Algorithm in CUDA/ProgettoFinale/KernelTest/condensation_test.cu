/*//---------------------------------------------------------------------------------------------------------
|
|  Test di Kernel simili che utilizzano memoria in modo diverso ( testi di funzionalita': mostrare che tutti fanno la stessa operazione)
|
*///---------------------------------------------------------------------------------------------------------
...
cout<<"CONDENSAZIONE VERSIONE 6 (2 texture)"<<endl; 
