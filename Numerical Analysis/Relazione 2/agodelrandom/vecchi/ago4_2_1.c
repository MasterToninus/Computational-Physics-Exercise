...
//sul errore statistico stampo la deviazione standard tra valore atteso e valore ottenuto in funzione dei numero di lanci di cui è composto l'esperimento
...
ofstream myfile("dev1.txt",ios::trunc);
