...
Runge_Kutta_secondo(F2,t,Th,w,dt,N);
    	...
    	ofstream myfile("forzante/F0_+",ios::trunc);
...
ofstream myfile1("forzante/F0_+_fasi",ios::trunc);
	...
	ofstream myfile3("forzante/F0_0",ios::trunc);
...
ofstream myfile4("forzante/F0_0_fasi",ios::trunc);
	...
	ofstream myfile5("forzante/F0_-",ios::trunc);
...
ofstream myfile6("forzante/F0_-_fasi",ios::trunc);
