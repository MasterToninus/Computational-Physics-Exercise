//dando la delta, il numero N di punti campionati e la funzione campionata da 0 a Ndelta mi restituisce la parte reale della trasformata da  (-fc a fc) campionata ogni ..
