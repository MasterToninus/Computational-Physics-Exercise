...
int main()
{
	int N_i=200;							//numero di nodi in una linea
	...
	for(int n=0;n<1;n++){ //stampo 4 grafici con diversi N
		int N= N_i-30*n;
		...
		double beta_min=beta_crit-0.10, beta_max= beta_crit -0.05;			//Primo pezzo_ prima della zona critica
		...
		beta_min = beta_max, beta_max= beta_crit +0.05;			//secondo pezzo_ intorno alla temperatura critica
		...
		beta_min = beta_max, beta_max = beta_crit + 0.1;						//terzo pezzo_ dopo la temperatura critica
