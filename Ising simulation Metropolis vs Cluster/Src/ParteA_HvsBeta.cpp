/*
STUDIO DIPENDENZA DELLA DENSITÀ DI ENERGIA DA BETA CON L'ALGORITMO A MULTICLUSTER
	produce un grafico h vs B con errore
...
int main()
{
	...
	stringstream sstm;
	sstm << "Output/ParteA/"<<"HvsBeta_N"<< N <<".dat";
