/*
PROBLEMA 1
Studiare la dipendenza della pressione da rho. (Nfisso - 2D)
...
int main()
{
	...
	string nomeFile ="Output/Problema1/PvsRho_2D.dat";
	...
	int n_dots = 120;
	double eta_max= 0.745, eta_min=0.345;
	...
	for(int i=0;i<=n_dots;i++){
		...
		grafico_add(nomeFile, 3, (double)rho_star(eta, d), (double)Y);
	}
