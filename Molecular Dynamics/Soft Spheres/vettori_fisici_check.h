/*	 Classe CALCOLO VETTORIALE per vettori "fisici" con il controllo delle dimensioni compatibili quando faccio calcoli
*/
...
vettore& operator+=(vettore a){
	if(d != a.d)cout<<"errore!dimensioni diverse nel calcolo -"<<endl;
...
{
	if(a1.d != a2.d)cout<<"errore! dimensioni diverse nel calcolo prod in"<<endl;
	double r=0;
