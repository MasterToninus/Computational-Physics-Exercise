...
plot "PvsEta_2D_ZonaMeta.dat" using 1:2:3 title "N = 450 (Metastabile)" w yerrorbars  lt 1 lc 1 lw 2.2
replot "PvsEta_2D.dat" using 1:2:3 title "N = 450" w yerrorbars  lt 1 lc 3 lw 2.2
...
set output 'PvsEta2D.eps'
replot
set output '|epstopdf  PvsEta2D.eps'
