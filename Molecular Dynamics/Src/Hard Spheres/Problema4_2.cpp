/*
PROBLEMA 4 parte 2
Studiare la distribuzione  del libero cammino  a vari rho. (Nfisso - 2D)
PRODUCE ISTOGRAMMA DELLA DISTRIBUZIONE DI PROBABILITÀ DEI VALORI DI LIBERO CAMMINO MEDIO RACCOLTI A VARI IMPACCHETTAMENTI
*/
...
for(int i=0;i<=n_graf;i++){
	...
	stringstream sstm;
	sstm << "Output/Problema4/DistroLC_eta"<<i<<".dat";
